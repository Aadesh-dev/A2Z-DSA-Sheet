class Solution {
    ...
    for (int i=0; i<s.length(); i++) {
      ...
      if (leftBalance<0) return false; // We know we have unbalanced parenthesis: opening < closing.
    }
    ...
    for (int i=s.length()-1; i>=0; i--) {
      ...
      if (rightBalance<0) return false;  // We know we have unbalanced parenthesis: opening > closing.
    }
